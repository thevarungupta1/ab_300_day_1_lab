...
# Exercise 3: LLM Ecosystem

### Business Use:
Enterprise want to use cheaper/faster models for classification and summarization

Use stronger models for reasining-heavy architecture decision


### Create main file
`modules/03_llm_ecosystem.py`
